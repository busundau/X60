...
#line 398 "Source\\PtsPta_InputOutput.c"
...
#line 681 "Source\\PtsPta_InputOutput.c"



#line 694 "Source\\PtsPta_InputOutput.c"
...
{
	if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(3))) + ((0)<<2)))) == 0)
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(3))) + ((0)<<2)))) = 1;
	else
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(3))) + ((0)<<2)))) = 0;
}
