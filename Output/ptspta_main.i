...
void Switch_P13_To_GPIO(void)
{
	...
	((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADCR &= ~(1ul << 0));
	CLK_DisableModuleClock(((1UL<<30)|(0x1<<28)|(0x3<<25) |( 2<<20)|(0x0<<18)|(0xFF<<10) |(16<<5)|28));
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)), 0x00000001 | 0x00000002 | 0x00000004 | 0x00000008 | 0x00000010 | 0x00000040, 0x1UL);

	 
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(1))) + ((6)<<2)))) = 0; 
