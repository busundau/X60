...
void OverCurrent_Check(void)
{
	...
	if(G_Current >= 2300) 
	{
		if(S_OverCurrentOverLoadCnt > (300/5)) 
		{
			Motor(0, G_Direction);
			printf("I2\n");
			G_BuzzerLED = eBehaving_CurrentOver;  
			G_MotorStatus = eMotorStatus_OverCurrent;
			S_OverCurrentOverLoadCnt = (300/5);
	...
	if(G_Current >= 1400) 
	{
		if(S_OverCurrentProtectCnt > (1200/5)) 
		{
			Motor(0, G_Direction);
			printf("I3\n");
			G_BuzzerLED = eBehaving_CurrentOver;  	
			G_MotorStatus = eMotorStatus_OverCurrent;
			S_OverCurrentProtectCnt = (1200/5);
		}
	}
	else
	{
